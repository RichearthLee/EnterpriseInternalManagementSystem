  ...
  <div id="context" class="content">
   ...
   <div><h2>评审</h2></div>
    ...
    <from class="form-horizontal" id="form_1" method="post">
         ...
         <p>问题反馈</p>
      <input id="briefingSign"    name="briefingSign"  class="form-control myinput" />
      ...
      <div id=bt><button id="bt_1" type="button" class="btn btn-success pull-center">已审阅</button></div>
...
/*   $("#briefing_Createtime").value(function show(){
  ...
  $("#bt_1").click(function(){
  	...
  	if(confirm("确认审阅吗")){
  		...
  		bfdata +="&briefingId="+<%=briefingInfo.getBriefingId()%>+"&briefingState=已审阅";
  		//alert(bfdata);
