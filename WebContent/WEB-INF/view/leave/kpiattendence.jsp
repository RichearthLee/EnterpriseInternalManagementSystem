...
<section class="content-header">
    ...
    <div class="col-sm-4">
		...
		<button id="updateFlag" type="button" class="btn btn-info"><span class="glyphicon glyphicon-plus"></span>修改权重</button></a>
	</div>
	...
	$(function(){
		...
		$.post("<%=request.getContextPath()%>/getKpiAttendenceListPage.json",ipage,function(data){
			$("#page-div").createPage({
	...
	function tbodyInit(data){
		...
		$.each(data,function(i,o){
				htmlstr += "<tr>"
					+	"<td>"+o.empName+"</td>"
					+	"<td>"+o.workTimeMarks+"</td>"
					+	"<td>"+o.extraWorkMarks+"</td>"
					+	"<td>"+o.goOutMarks+"</td>"
					+	"<td>"+o.lateMarks+"</td>"
					+	"<td>"+o.eleaveMarks+"</td>"
					+	"<td>"+o.neglectMarks+"</td>"
					+	"<td>"+o.leaveMarks+"</td>"
					+	"<td>"+o.kpi+"</td>"
					+	"<td>"+o.yearMonth+"</td>"
	...
	$("#updateFlag").click(function(){
		window.location.href ="<%=request.getContextPath()%>/updateFlag";	
	});
